...
一个面向 Windows 浏览器和 Android 浏览器的单人俄罗斯方块 Web/PWA。安卓端以滑屏和轻触为主，仓库内置 GitHub Pages 静态发布工作流，并提供 6 套内置主题皮肤。
